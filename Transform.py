...
def ConvertAndInsert(path):
    ...
    path1 = path+"/data/aggregated/transaction/country/india/state/"
    ...
    path2 =  path+"/data/aggregated/user/country/india/state/"
    ...
    path3 =  path+"/data/aggregated/insurance/country/india/state/"
    ...
    path4=  path+"/data/map/insurance/hover/country/india/state/"
    ...
    path5 =  path+"/data/map/transaction/hover/country/india/state/"
    ...
    path6 =  path+"/data/map/user/hover/country/india/state/"
    ...
    path7 =  path+"/data/top/transaction/country/india/state/"
    ...
    path8 =  path+"/data/top/user/country/india/state/"
    ...
    path9 =  path+"/data/top/insurance/country/india/state/"
    ...
    database.InsertToDatabase(aggre_transaction,aggre_user,aggre_insurance,map_insurance,map_transaction,map_user,top_transaction,top_user,top_insurance)
